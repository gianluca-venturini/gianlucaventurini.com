...
# Consciousness
- intro
Everyone experiences consciousness. It's similar to an emotion and provides us with a sense of individual identity, rather than making us perceive ourselves as merely a collection of cells. Consciousness might be the feeling we experience while our relatively complex brain is functioning.

- definition of consciousness
When we say that a being is conscious we mostly refer to an arbitrary set of intellective skills on intelligence spectrum, like self-awareness and displaying emotions. We can draw an analogy between simple beings to combinatorial circuits (output depends only on inputs, no internal state). For example, ants mostly react to their external environment and function like a small lookup table; given current sensory inputs, they act in a deterministic way. More complex beings, such as predators, need to remember past experiences, learn from them, react based on their emotions and engage in complex problem solving.
