...
When I have an idea, I open [Obsidian on my iPad](https://apps.apple.com/us/app/obsidian-connected-notes/id1557175442), create a new text file, and start writing. I frequently commit my progress to a Git branch using Working Copy. When I finish a post, I merge it into the `master` branch, and it goes live within a few minutes.
