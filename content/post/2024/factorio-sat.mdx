...
![The last Furnace is sometime idle waiting for new resources. We don't want that.](</uploads/factorio-tools/no_balancer.webp>)
...
![4 x 4 naïve Throughput-Limited belt balancer](</uploads/factorio-tools/4_4_limited.webp>)
...
![Banes network for a 8x8 balancer](</uploads/factorio-tools/network.png>)
