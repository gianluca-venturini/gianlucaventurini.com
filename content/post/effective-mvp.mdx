---
title: 'Develop new software: building an effective MVP'
snippet: >-
  How to build an effective MVP. Moonshot VS Execution Heavy MVP, why building
  it, with who, how and few traps I fell into in the past.
cover: /uploads/mvp/2AD109EB-7D82-4C99-AA28-A1FFBB744253.webp
...
Building MVPs is more art than science, we get better with practice. I often build MVPs of systems I read about in papers or blog posts to practice this myself. I really think it’s a powerful tool in software development. Especially now that implementing multiple solutions to the same problem is becoming exponentially faster with AI assisted code development (e.g. [Copilot](https://github.com/features/copilot) or [Cursor](https://www.cursor.com)).
